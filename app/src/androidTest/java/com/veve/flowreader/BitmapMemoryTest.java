...
public class BitmapMemoryTest {
    ...
    public void testMemory() {
        ...
        for (int height = 1000; height < 25000; height += 1000) {
            ...
            assertNotNull("OOM at " + width + "x" + height, bm);
            bm = null;
            System.gc();
        }
    }
    ...
    public void testConversion() {
        ...
        Bitmap convertedBitmap = Bitmap.createBitmap(bitmap.getWidth(), bitmap.getHeight(), bitmap.getConfig());
        convertedBitmap.copyPixelsFromBuffer(byteBuffer);

        assertTrue(bitmap.sameAs(convertedBitmap));
    }
