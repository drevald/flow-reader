...
//        findViewById(R.id.page).setOnTouchListener(new View.OnTouchListener() {
//            @Override
//            public boolean onTouch(View v, MotionEvent event) {
//                Log.v("EVENT", getActionName(event.getAction()));
//
...
//        });
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            findViewById(R.id.page).setOnScrollChangeListener(new View.OnScrollChangeListener() {
                @Override
                public void onScrollChange(View v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                    Log.v("EVENT", v.toString());
                }
            });
        }

//        findViewById(R.id.page).setOnClickListener(new OnClickListener() {
//            @Override
